...
public class EmployerJobDeleteTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/employer/job/delete-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
