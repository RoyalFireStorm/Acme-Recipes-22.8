...
@Service
public class AnyJobShowService implements AbstractShowService<Any, Job> {
	...
	public void unbind(final Request<Job> request, final Job entity, final Model model) {
		...
		request.unbind(entity, model, "reference", "deadline", "title", "salary", "score", "moreInfo", "description");
	}
